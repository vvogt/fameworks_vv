				...
				<div className="contact">
					...
					<div className="contact__content">
						<div className="contact__content__left">
							...
							>
								{this.renderOptions(
									Object.keys(this.props.contactOptions)
								)}
							</select>
						</div>
								...
								<div className="mail">
									...
									{this.state.currentContent.mailInfo && (
										<div className="mail_info">
											<p>{this.state.currentContent.mailInfo}</p>
										</div>
									)}
								</div>
								{this.state.currentContent.phone && (<div className="phone">
									<a	href={`tel: ${this.state.currentContent.phone}`}>
										{this.state.currentContent.phone}
									</a>
									{this.state.currentContent.phoneInfo && (
										<div className="phone_info">
											<p>{this.state.currentContent.phoneInfo}</p>
										</div>
									)}
								</div>)}
							</div>
					...
					<div className="contact__footer">
						<div className="contact__footer__left">
							<a href="http://www.cityoflondon.gov.uk" className="logo">
								<img src={LondonLogo} alt="London City logo" />
							</a>
							<p>
								The City of London Corporation is the founder and
								principal funder of the Barbican Centre
							</p>
						</div>
						<div className="contact__footer__center">
							<p>Centre partner</p>
							<a href="http://barbivan.org.uk">
								<img src={ChristieLogo} alt="Christie logo" />
							</a>
						</div>
						<div className="contact__footer__right">
							<img src={FbLogo} alt="Bardican Facebook page" />
							<img src={TwitterLogo} alt="Bardican Twitter page" />
							<img src={InstagramLogo} alt="Bardican Instagram page" />
						</div>
					</div>
					<div className="contact__bottom-links">
						<nav className="bottom-nav">
							<ul>
							  	<li>
                  			<a className="darker" href="/careers">Careers</a>
									<a className="darker" href="/pressroom">Press room</a>
									<a className="darker" href="/pivacy">Privacy</a>
									<a className="darker" href="/terms">Terms & conditions</a>
                			</li>
							</ul>
						</nav>
						<p>© 2020 Barbican Centre, Silk Street, London, EC2Y 8DS</p>
					</div>
				</div>
			</footer>
		);
