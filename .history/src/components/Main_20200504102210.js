...
import SignupSection from './SectionSignup';
    ...
    return (
      <div className="wrapper">
        ...
        <SignupSection
          ...
          listPoints={["Be the first to hear before events go on sale", "Get the latest news from Barbican", "Choose the types of events that interest you"]}
          buttonText="Sign up"
        />
      </div>
    );
