        ...
        <footer>
          <div className="contacts">
            ...
            <div className="contacts__footer">
               <div className="contacts__footer__left"></div>
               <div className="contacts__footer__center"></div>
               <div className="contacts__footer__right"></div>
{/*               <div className="contacts__footer__left">
